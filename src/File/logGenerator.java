...
public class logGenerator {
    ...
    public static void TCP_connection_initiate(int peerid) {
        Date date = new Date();
    ...
    public static void TCP_connection_made(int peerid) {
        Date date = new Date();
        String h = date.toString();
    ...
    public static void haveReceived(int peerid){
        Date date = new Date();
        String h = date.toString();
    ...
    public static void interestedReceived(int peerid){
        Date date = new Date();
        String h = date.toString();
    ...
    public static void notInterestedReceived(int peerid){
        Date date = new Date();
        String h = date.toString();
    ...
    public static void downloadedPiece(int peerid,int pieceIndex){
        Date date = new Date();
        String h = date.toString();
